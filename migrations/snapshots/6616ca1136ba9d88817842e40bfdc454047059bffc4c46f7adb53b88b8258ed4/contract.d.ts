...
export type StorageHash =
  StorageHashBase<'6616ca1136ba9d88817842e40bfdc454047059bffc4c46f7adb53b88b8258ed4'>;
...
export namespace Models {
  export type public_User = {
    ...
    magicLinks: public_MagicLinkToken[];
    memories: public_Memory[];
    sessions: public_Session[];
    readonly [RelationKeys]?:
      'auditLogs' | 'conversations' | 'magicLinks' | 'memories' | 'sessions';
  };
  ...
  export type public_MagicLinkToken = {
    id: CodecTypes['pg/int4@1']['output'];
...
export declare const models: {
  public: {
    ...
    MagicLinkToken: Models.public_MagicLinkToken;
        ...
        readonly entries: {
          readonly table: {
            ...
            readonly magicLinkToken: {
              ...
              indexes: readonly [
                {
                  readonly name: 'magicLinkToken_userId_idx_a489d58a';
                  readonly prefix: 'magicLinkToken_userId_idx';
                  readonly columns: readonly ['userId'];
                  readonly unique: false;
                },
              ];
              foreignKeys: readonly [
                {
                  readonly source: {
                    readonly namespaceId: 'public' & NamespaceId;
                    readonly tableName: 'magicLinkToken';
                    readonly columns: readonly ['userId'];
                  };
                  readonly target: {
                    readonly namespaceId: 'public' & NamespaceId;
            ...
            readonly projectPerson: {
              ...
              primaryKey: { readonly columns: readonly ['id'] };
              uniques: readonly [{ readonly columns: readonly ['projectId', 'personId'] }];
              indexes: readonly [
                {
